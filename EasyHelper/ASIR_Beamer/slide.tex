...
\author{ASIR}
\title{ASIR Beamer Theme}
\subtitle{ASIR汇报 Beamer 模板}
\institute{先进感知与交互研究组}
\date{\today}
\usepackage{asir}
% This template is modified from westlake university's beamer temlate
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/ASIR.png}
        \end{center}
    \end{figure}
\end{frame}
